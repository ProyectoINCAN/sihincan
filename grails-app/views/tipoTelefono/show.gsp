...
<html>
    ...
    <body>
        ...
        <div id="show-tipoTelefono" class="content scaffold-show" role="main">
            ...
            <f:display bean="tipoTelefono" />
            <g:form resource="${this.tipoTelefono}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.tipoTelefono}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
